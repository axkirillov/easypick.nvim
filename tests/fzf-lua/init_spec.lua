...
describe("setup", function()
	it("should succeed configuring with fzf-lua ", function()
		assert.no_error(
			function() easypick.setup({
				provider = "fzf-lua",
			}) end
		)
	end)
	...
	it("should print an error message for telescope dependency when configured", function()
		assert.error(
